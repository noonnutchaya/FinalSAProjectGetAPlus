        ...
        return (
            ...
            <Upload.Dragger name="files"  onChange={this.handleChange}> 
                ...
                <p className = "ant-upload-drag-icon" >
                  ...
                  <Icon type="file-text" theme="twoTone" twoToneColor="#A0A0A0" />
                  <Icon type="file-image" theme="twoTone" twoToneColor="#A0A0A0" />
                  <Icon type="file-pdf" theme="twoTone" twoToneColor="#A0A0A0" />
